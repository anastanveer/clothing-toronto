                        ...
                        <div class="col-xl-4 col-md-7">
                            <form action="{{ route('login.submit') }}" method="POST" class="ul-contact-form">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-3">
                                    ...
                                    <a href="{{ route('password.request') }}" class="ul-form-link">Forgot password?</a>
                                </div>
                                <!-- submit btn -->
                            ...
                            <div class="ul-social-login mt-4">
                                <p class="ul-social-login__eyebrow">Or continue with</p>
                                ...
                                <p class="small text-muted mb-0">Sign in to snag 50 Glamer reward points on your next purchase. Guests can still shop without logging in.</p>
                            </div>
                        </div>
                    </div>
                </div>
